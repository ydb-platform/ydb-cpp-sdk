...
#include <client/ydb_federated_topic/impl/federated_topic_impl.h>

#include <client/ydb_persqueue_core/impl/write_session.h>

#include <client/ydb_topic/impl/write_session.h>
...
public:
    ...
    virtual void Write(NTopic::TContinuationToken&&, TStringBuf, std::optional<ui64> seqNo = std::nullopt,
