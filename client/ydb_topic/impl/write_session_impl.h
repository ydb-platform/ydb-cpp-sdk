...
private:
    ...
    struct TMessage {
        ...
        TMessage(ui64 id, const TInstant& createdAt, TStringBuf data, std::optional<ECodec> codec = {},
...
public:
    ...
    void Write(TContinuationToken&&, TStringBuf, std::optional<ui64> seqNo = std::nullopt,
