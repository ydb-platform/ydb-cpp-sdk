...
static void DebugStringImpl(const TReadSessionEvent::TDataReceivedEvent::TMessageInformation& info, TYdbStringBuilder& ret) {
    ret << " Information: {"
        << " Offset: " << info.Offset
        << " SeqNo: " << info.SeqNo
...
static void DebugStringImpl(TYdbStringBuilder& ret,
...
void TReadSessionEvent::TDataReceivedEvent::TMessage::DebugString(TYdbStringBuilder& ret, bool printData) const {
    DebugStringImpl(ret, "Message", *this, printData, [this](TYdbStringBuilder& ret) {
...
void TReadSessionEvent::TDataReceivedEvent::TCompressedMessage::DebugString(TYdbStringBuilder& ret, bool printData) const {
    DebugStringImpl(
        ret,
        "CompressedMessage",
        *this,
        printData,
        [this](TYdbStringBuilder& ret) {
