...
void TWriteSessionImpl::WriteInternal(
            TContinuationToken&&, TStringBuf data, std::optional<ECodec> codec, ui32 originalSize, std::optional<ui64> seqNo, std::optional<TInstant> createTimestamp
        ) {
...
void TWriteSessionImpl::WriteEncoded(
            TContinuationToken&& token, TStringBuf data, ECodec codec, ui32 originalSize, std::optional<ui64> seqNo, std::optional<TInstant> createTimestamp
        ) {
    WriteInternal(std::move(token), data, codec, originalSize, seqNo, createTimestamp);
}

void TWriteSessionImpl::Write(
            TContinuationToken&& token, TStringBuf data, std::optional<ui64> seqNo, std::optional<TInstant> createTimestamp
        ) {
