...
static inline std::string Ip6ToString(const TIp6& ip) {
    char buf[INET6_ADDRSTRLEN];

    return std::string(Ip6ToString(ip, buf, sizeof(buf)));
}
...
static inline std::string Ip4Or6ToString(const TIp4Or6& ip) {
