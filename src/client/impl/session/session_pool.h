...
private:
    class TWaitersQueue {
    public:
        TWaitersQueue(std::uint32_t maxQueueSize, TDuration maxWaitSessionTimeout=MAX_WAIT_SESSION_TIMEOUT);
...
private:
    ...
    NSdkStats::TAtomicCounter<NMetrics::IRate> FakeSessionsCounter_;
};
