...
TDateTypeColumnModeSettings::TDateTypeColumnModeSettings(const std::string& columnName, const TDuration& deprecatedExpireAfter)
...
TValueSinceUnixEpochModeSettings::TValueSinceUnixEpochModeSettings(const std::string& columnName, EUnit columnUnit, const TDuration& deprecatedExpireAfter)
    : ColumnName_(columnName)
...
TTtlSettings::TTtlSettings(const std::string& columnName, const std::vector<TTtlTierSettings>& tiers)
...
TTtlSettings::TTtlSettings(const std::string& columnName, EUnit columnUnit, const std::vector<TTtlTierSettings>& tiers)
...
std::optional<TDuration> TTtlSettings::GetExpireAfterFrom(const std::vector<TTtlTierSettings>& tiers) {
...
TTtlSettings::TTtlSettings(TMode mode, const std::vector<TTtlTierSettings>& tiers, uint32_t runIntervalSeconds)
    : Mode_(std::move(mode))
    , Tiers_(tiers)
    , RunInterval_(TDuration::Seconds(runIntervalSeconds))
{ }
