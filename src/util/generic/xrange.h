...
<<<<<<< HEAD
>>>>>>>> ed2145fb77 (Moved SDK code to src (#149)):src/util/generic/xrange.h
=======
 ...
 *  }
 *
 * std::vector<int> arithmeticSeq = xrange(10); // instead: std::vector<int> arithmeticSeq; for(size_t i = 0; i < 10; ++i) { arithmeticSeq.push_back(i); }
 *
 */
