...
Y_UNIT_TEST_SUITE(StorePolicy) {
    Y_UNIT_TEST(Compileability) {
        // construction
        TAutoEmbedOrPtrPolicy<std::unique_ptr<int>>(MakeHolder<int>(1));
        ...
        // const
        (**TAutoEmbedOrPtrPolicy<std::unique_ptr<int>>(MakeHolder<int>(1)).Ptr())++; // ok
    ...
    Y_UNIT_TEST(Object) {
        ...
        std::unique_ptr<int> b = MakeHolder<int>(42);
