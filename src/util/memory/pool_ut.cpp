...
private:
    inline void TestMemPool() {
        ...
        {
            TMemoryPool pool(123, TMemoryPool::TExpGrow::Instance(), &alloc);
            std::unique_ptr<TConstructorTest, TDestructorUnique> data1{pool.New<TConstructorTest>()};
            std::unique_ptr<TConstructorTest, TDestructorUnique> data2{pool.New<TConstructorTest>(42)};
            std::unique_ptr<TConstructorTest, TDestructorUnique> data3{pool.New<TConstructorTest>("hello", "world")};
