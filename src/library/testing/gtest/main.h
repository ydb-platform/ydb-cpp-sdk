...
namespace NGTest {
    ...
    /**
     * Parse unittest-related flags. Test binaries support flags from `src/library/testing/unittest` and flags from gtest.
     * This means that there are usually two parsing passes. The first one parses arguments as recognized
     * by the `src/library/testing/unittest`, so things like `--trace-path` and filters. The second one parses flags
