...
class TWriteVarIntTest: public ::testing::TestWithParam<std::tuple<ui64, std::string> >
{ };
...
TEST_P(TReadVarIntTest, Serialization)
{
    ...
    std::stringInput inputStream(input);
    ui64 value;
...
{
    std::string input("\x80\x80\x80\x80\x80\x80\x80\x80\x80\x80\x01", 11);
    std::stringInput inputStream(input);
    ui64 value;
