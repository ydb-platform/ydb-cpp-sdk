...
void RunPerf() {
    ...
    Y_UNIT_TEST(DifferentPercentiles) {
        TPercentileTrackerLg<5, 4, 15> tracker;
        std::vector<size_t> values({0, 115, 1216, 15, 3234567, 1234567, 216546, 263421, 751654, 96, 224, 223, 225});
        std::vector<size_t> percentiles50({0, 0, 116, 15, 116, 116, 1216, 1216, 217056, 1216, 1216, 224, 232});
        std::vector<size_t> percentiles75({0, 116, 116, 116, 1216, 1245152, 217056, 270304, 753632, 753632,
                270304, 270304, 270304});
        std::vector<size_t> percentiles90({ 0, 116, 1216, 1216, 2064352, 1245152, 1245152, 1245152, 1245152,
                1245152, 1245152, 1245152, 1245152});
        std::vector<size_t> percentiles100({ 0, 116, 1216, 1216, 2064352, 2064352, 2064352, 2064352, 2064352,
