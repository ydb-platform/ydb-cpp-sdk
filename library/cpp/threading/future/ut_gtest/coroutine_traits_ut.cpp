...
TEST(TestFutureTraits, Exception) {
    ...
    try {
        ...
        ADD_FAILURE() << "Expected yexception";
    } catch (const yexception& e) {
        EXPECT_THAT(e.AsStrBuf(), ::testing::HasSubstr("coroutine2 exception"));
    }
    EXPECT_THAT(
        result,
        ::testing::ContainerEq(
    ...
    EXPECT_DEATH(
        {
            ...
            try {
                ...
                EXPECT_THAT(e.AsStrBuf(), ::testing::HasSubstr("bad coroutine exception"));
            }
