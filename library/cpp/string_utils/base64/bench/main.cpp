...
static std::string GenerateRandomData(const size_t minSize, const size_t maxSize) {
...
template <size_t N>
static std::array<std::string, N> GenerateRandomDataVector(const size_t minSize, const size_t maxSize) {
...
template <size_t N>
static std::array<std::string, N> Encode(const std::array<std::string, N>& d) {
    std::array<std::string, N> r;
...
namespace {
    ...
    struct TRandomDataHolder {
        ...
        const std::array<std::string, N> Data;
        const std::array<std::string, N> DataEncoded;
