...
namespace NDiff {
    ...
    size_t InlineDiff(std::vector<TChunk<wchar16>>& chunks, const std::u16string_view& left, const std::u16string_view& right, const TUtf16String& delims = TUtf16String());
