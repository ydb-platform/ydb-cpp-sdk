...
set(NAYUKI_MD5_ROOT $ENV{HOME}/nayuki_md5)

file(WRITE ${NAYUKI_MD5_ROOT}/nayuki_md5.h
"#pragma once\n
#include <stdint.h>\n
...
file(READ ${NAYUKI_MD5_ROOT}/nayuki_md5.c MD5_CURRENT)
...
file(WRITE "${NAYUKI_MD5_ROOT}/nayuki_md5.c" "${MD5_CURRENT}")

find_path(NAYUKI_MD5_INCLUDE_DIR
  "nayuki_md5.h"
  HINTS ${NAYUKI_MD5_ROOT}
)
